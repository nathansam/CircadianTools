...
#' AgglomClustering:
#' @description Applies agglomerative hierarchical clustering to a transcriptomics dataset and appends a cluster column to this dataset for all genes.
...
#'
#' @export
AgglomClustering <- function(dataset, distance=NULL, k = 10, metric = "euclidean", nthreads = NULL, scale = FALSE, center = TRUE) {
