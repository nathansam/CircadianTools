...
turningplot <- function(genename,dataset,timelag=0 ,print = TRUE, save = FALSE) {
    ...
    turning.points <- rootSolve::uniroot.all(genesplinefunc, interval = c(6, 27),
        deriv = 1)  # this outputs a vector of the turning points, i.e. the points where the derivative=0
