#' Jaccard
#'
#' @description Stolen from the clusteval package as there is currently a bug with the package
#' on CRAN where this function is not exported from the namespae of clusteval.
